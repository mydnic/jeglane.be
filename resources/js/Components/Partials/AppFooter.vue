...
<!--                        </svg>-->
<!--                    </a>-->
                    <a href="https://github.com/mydnic/jeglane" class="text-gray-400 hover:text-gray-500">
                ...
                <p class="mt-8 text-xs leading-5 text-gray-500 md:order-1 md:mt-0">&copy; {{ new Date() }} MY DYNAMIC PRODUCTION SRL. Tous droits réservés.</p>
            </div>
        </div>
    </footer>
</template>
