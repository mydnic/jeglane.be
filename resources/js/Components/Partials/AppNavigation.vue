    ...
    <Menubar :model="items">
        ...
        <template #end>
            <div class="flex items-center gap-2" v-if="$page.props.auth.user">
                ...
                <Button type="button"
                        text
                        :label="$page.props.auth.user.name" @click="toggle" severity="secondary"
        ...
        },
    {
        ...
        command: () => {
            ...
            <div class="flex items-center gap-2" v-else>
                <Button type="button" text label="Connexion" @click="this.$inertia.visit('/login')" />
                <Button type="button" label="Inscription" @click="this.$inertia.visit('/register')" />
            </div>
        </template>
    </Menubar>
</template>
